  ...
  actions: {
    nextPage: function() {
      if(!((parseInt(this.get('currentPage')) + 1) > parseInt(this.get('model.pageChecker')))) {
        this.transitionToRoute('account.admin.deposits', parseInt(this.get('currentPage')) + 1);
      }
    },
    ...
    firstPage: function() {
      this.transitionToRoute('account.admin.deposits', 1);
    },

    lastPage: function() {
      this.transitionToRoute('account.admin.deposits', this.get('model.pageChecker'));
    }
  }
